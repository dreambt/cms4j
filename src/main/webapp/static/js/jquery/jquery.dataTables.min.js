...
sLengthMenu:"每页显示 _MENU_ 个",sZeroRecords:"没有满足要求的数据",sEmptyTable:"空表",sInfo:"共计 _TOTAL_ 条记录, 本页显示从 _START_ 到 _END_ 的记录.",sInfoEmpty:"共 0 条记录, 本页显示从 0 到 0 的记录.",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"搜索:",sUrl:"",oPaginate:{sFirst:"首页",sPrevious:"前一页",sNext:"下一页",sLast:"最后一页"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=

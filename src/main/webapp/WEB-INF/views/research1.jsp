...
<div class="span-19">
    <div class="span-7">
        <div class="container_index span-7-border">
            ...
            <p class="researchDesc train">
                金融风险管理研究所围绕着新资本协议框架，基于流程银行的最佳实践，结合人工智能、数据挖掘技术和各种数据分析方法，研究经济及金融一体化趋势下金融风险的识别、度量和控制理论与应用，特别是金融信用风险评估指标体系、风险分析模型及预警系统、商业银行结构性风险管理系统、证券投资风险预测与管理工具等。研究所依托山东财经大学的学科优势，与相关企业、科研单位在金融机构全面风险管理方面开展产学研合作，促进科技成果的转化与应用。</p>

            <p class="researchDesc train">
                专家团队由具有较高理论造诣的高校教师和具有丰富实际工作经验的业界专家组成。其中教授2人，副教授、高级工程师和高级系统分析师6人，团队成员大多具有博士学位或具有海外学习与工作经历。</p>
        </div>
        <div class="container_index span-7-border">
            <p class="title_index title-268"><strong>产学研合作</strong><%--<a href="#" class="more">更多>></a>--%></p>

            <p class="brief">
                本研究所与山东省城商联盟、山东省农信社等多家金融机构，山东舜德数据管理软件公司等多家国内外企业建立了长期的紧密合作关系。承担国家自然基金项目1项、省部级科研课题及企业委托研发课题6项。独立研究及与合作伙伴共同研发的成果已取得软件著作权6项，申报国家发明专利2项，“基于流程管理的商业银行资产管理系统”和“基于Basel
                II的商业银行内部评级系统”等多项成果已成功应用于交通银行、广发银行、恒丰银行、齐鲁银行、德州商行及小额贷款公司等非银行金融机构。</p>
        </div>
    </div>
    <!---left_l end----->
    <div class="span-12 last">
        <div class="container_index span-12-border">
            ...
            <p class="brief">
                围绕着新资本协议框架，基于流程银行的最佳实践，结合人工智能、数据挖掘技术和各种数据分析方法，研究经济及金融一体化趋势下金融信用风险评估指标体系、风险分析模型及预警系统、商业银行风险管理系统、证券投资风险预测模型与管理工具等</p>
        ...
        <div class="container_index span-12-border">
            ...
            <ul class="content span-6">
                <c:forEach items="${infos}" var="info" begin="0" step="1" end="2">
                    <li class="counseling"><c:if test="${info.message!=''}"><a
                            href="${ctx}/article/content/${info.id}">${fn:substring(info.subject,0,15)}</a></c:if></li>
                </c:forEach>
            </ul>
    ...
    <div id="left_b">
        ...
        <div class="scrolllist" id="teacher">
            ...
            <div class="imglist_w">
                <ul class="imglist">
                    <li>
                        <a target="_self" href="${ctx}/article/content/70" title="田茂圣"><img width="120" height="166"
                                                                                            alt="田茂圣"
                                                                                            src="${ctx}/static/uploads/teacher/pic_tianmaosheng.jpg"></a>

                        <p>田茂圣</p>
                    </li>
                    <li>
                        <a target="_self" href="${ctx}/article/content/72" title="赵志崑"><img width="120" height="166"
                                                                                            alt="赵志崑"
                                                                                            src="${ctx}/static/uploads/teacher/pic_zhaozhikun.jpg"></a>

                        <p>赵志崑</p>
                    </li>
                    <li>
                        <a target="_self" href="${ctx}/article/content/71" title="林培光"><img width="120" height="166"
                                                                                            alt="林培光"
                                                                                            src="${ctx}/static/uploads/teacher/pic_linpeiguang.jpg"></a>

                        <p>林培光</p>
                    </li>
                    <li>
                        <a target="_self" href="${ctx}/article/content/68" title="刘文金"><img width="120" height="166"
                                                                                            alt="刘文金"
                                                                                            src="${ctx}/static/uploads/teacher/pic_liuwenjin.jpg"></a>

                        <p>刘文金</p>
                    </li>
                    <li>
                        <a target="_self" href="${ctx}/article/content/69" title="王帅强"><img width="120" height="166"
                                                                                            alt="王帅强"
                                                                                            src="${ctx}/static/uploads/teacher/pic_wangshuaiqiang.jpg"></a>
...
<div class="span-5 last">
    <div class="container_index span-5-border">
        ...
        <p class="brief train">
            内容包括全面风险管理的框架以及风险管理的演进、巴塞尔新资本协议的构成，新旧协议的差别；包括对银行信用风险、市场风险、操作风险的风险评估、风险计量和风险控制的各种技术、方法、工具和方案的分析，并配以实际的案例讲解。</p>
        <h6 class="subTitle">金融风险管理师 (FRM)</h6>

        <p class="brief train">
            内容包括数量分析、市场风险衡量与管理、信用风险衡量与管理、操作与整体风险管理、法律、会计与伦理等，将FRM(金融风险管理师)核心课程与中国金融风险管理现实需求结合，度身定制中国金融业需要的金融风险管理专业高端人才。</p>
        <h6 class="subTitle">风险管理数量分析</h6>

        <p class="brief train">
            内容包括：金融风险管理的基本原理、金融风险度量的VAR方法及应用、信用风险的度量方法、信用风险的管理方法、风险预算管理、流动性风险管理、操作风险管理、事件风险管理、蒙特卡洛方法、数量分析技术在风险管理中的运用。</p>
    </div>
    <div class="container_index span-5-border">

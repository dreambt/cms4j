    ...
    <div class="container">
        <div class="span8" style="margin-left: 0;">
                    ...
                    <div id="slideshow">
                        <c:forEach items="${images}" var="image" begin="0" step="1">
                            <div class="slide-text">
                                <h7>${image.title}</h7>
                                <img src="${ctx}/static/uploads/gallery/thumb-460x283/${image.imageUrl}" alt=""/>
                            </div>
                        </c:forEach>
                    </div>
            ...
            <div class="span5" style="margin-left: 10px;">
                ...
                <fieldset class="container_r">
                    <legend class="consult"><strong>咨询服务</strong><a href="#" class="more span2" style="float: right;">更多>></a></legend>
                    <ul>

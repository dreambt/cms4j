    ...
    <div id="content-left">
        <div class="maincontent">
            <div class="blog-post">
                ...
                <div align="center"><img src="${ctx}/static/uploads/agency/3.jpg" /></div><br/><br/>
                博士， 副教授，IEEE会员，毕业于山东大学信息科学与工程学院，获工学博士学位，担任《IEEE Trans. on  Information Forensics and Security》、《IET image processing》、《电子学报》等国内外期刊和会议审稿人，近年来主持国家自然基金一项，省两化融合研究课题一项，参与国家973项目、国家自然基金和省自然基金项目四项，在《IEEE Signal Process Letters》、《电子与信息学报》等期刊和会议上发表论文二十余篇，申请专利两项。主要研究方向为金融信息安全、内容安全认证等。
            </div>

...
<div class="main_container container_16 clearfix">
    ...
    <button class="button_colour" id="check_attachemnt" type="submit"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/white/BendedArrowRight.png"/>批量审核</button>
    <button class="button_colour" id="del"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/white/BendedArrowRight.png"/>批量删除</button>
    </form>
</div>
</body>
</html>

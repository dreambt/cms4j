...
<div class="main_container container_16 clearfix">
    <form:form modelAttribute="article" id="articleForm" method="post">
        ...
        <button class="button_colour" id="auditAll"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/white/BendedArrowRight.png"/><span>批量审核</span></button>
        <button class="button_colour" id="deleteAll"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/white/BendedArrowRight.png"/><span>批量删除</span></button>
    </form:form>
</div>
<script>
    $(function () {

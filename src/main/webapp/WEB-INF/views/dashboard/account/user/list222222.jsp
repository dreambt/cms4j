        ...
        <form:form id="userInfo" modelAttribute="user" action="${ctx}/account/user/save/${user.id}" method="post">
            ...
            <ul>
                ...
                <li>
                    ...
                    <button type="submit" id="audit"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/Listw_Image.png"><span>审核</span></button>
                    <button type="submit" id="delete"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/LoadingBar.png"><span>删除用户</span></button>
                    <button type="submit" id="repass"><img height="24" width="24" alt="Bended Arrow Right" src="${ctx}/static/dashboard/images/icons/Refresh.png"><span>重置密码</span></button>
                </li>
            </ul>
        </form:form>
    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.sliderClick').click(function () {
            ...
            alert("${ctx}/account/user/get?id=" + user_id);
            $.ajax({

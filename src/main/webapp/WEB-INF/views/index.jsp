...
<div class="span-19">
    ...
    <div class="span-12 last">
        <div class="container_index">
            <p class="span-12 title_index"><a href="#"><strong>中心简介</strong></a></p>
        ...
        <div class="container_index span-12">
            <p class="span-12 title_index"><a href="#"><strong>组织机构</strong></a></p>
        ...
        <div class="container_index">
            <p class="span-12 title_index"><a href="${ctx}/article/listInfo"><strong>咨询服务</strong></a></p>
...
<div class="span-5 last">
    <div class="container_index container_right">
        <p class="title_index span-5"><strong>服务对象</strong><%--<a href="#" class="more">更多>></a>--%></p>

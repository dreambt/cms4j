...
<body>
    <div id="index_left">
        <div id="left_l">
            ...
            <div class="container_index container_l">
                <p class="title_index title_l">
                    <strong>新闻动态</strong><span class="more"> <a href="${ctx}/article/list/3">更多>></a></span>
                </p>
            ...
            <div class="container_index container_l">
                <p class="title_index title_l">
                    <strong>通知公告</strong><span class="more"> <a href="${ctx}/article/list/4">更多>></a></span>
                </p>
                <ul class="content l_content">
        ...
        <!---left_l end----->
        <div id="left_r">
            <div class="container_index container_r">
    ...
    <div id="index_right">
        ...
        <div class="container_index container_right">
            <p class="title_index title_rl"><strong>行业资讯</strong><span class="more"> <a href="${ctx}/article/list/" class="more">更多>></a></span></p>
            <ul class="content r_content">
                <c:forEach items="${news2}" var="new2" begin="0" step="1">

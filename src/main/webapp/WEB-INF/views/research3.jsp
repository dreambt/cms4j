...
<div class="row">
    <div class="span12">
        <img id="banner" src="${ctx}/static/uploads/agency/1336285889720-RoZ0EU.png"/>
    </div>
</div>
<div class="row">
    <!-- 左栏 -->
                        ...
                        <div class="scrolllist" id="teacher">
                            ...
                            <div class="imglist_w">
                                <ul class="imglist">
                                    ...
                                    <li>
                                        <a target="_self" href="${ctx}/article/content/73" title="徐如志"><img width="120" height="166" alt="徐如志" src="${ctx}/static/uploads/teacher/pic_xuruzhi.jpg"></a>
                                        <p>徐如志</p>
                                    </li>
                                    <li>

...
<div id="login_box" class="round_all clearfix">
    <form:form id="loginForm" action="${ctx}/login" method="post">
        ...
        <div id="message" class="alert alert_red">
            <img height="24" width="24" src="${ctx}/static/dashboard/images/icons/small/white/Locked2.png"><strong>用户已被屏蔽,请登录其他用户.</strong>
        </div>
        <%
        }else{
        %>
        <div id="message" class="alert alert_red">
            <img height="24" width="24" src="${ctx}/static/dashboard/images/icons/small/white/Locked2.png"><strong>登录失败，请重试.</strong>
        </div>
        <%
                }
            }

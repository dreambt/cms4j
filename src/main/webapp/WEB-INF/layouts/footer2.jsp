...
<!-- BEGIN FOOTER -->
<div id="footer" class="span-24 left">
    <div id="footer1" class="prepend-1 span-7 left">
    ...
    <div id="footer2" class="prepend-1 span-6 append-1 left">
        <ul id="social">
    ...
    <div id="footer3" class="span-7 append left last">

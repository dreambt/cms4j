...
<div id="sidebar">
    ...
    <ul id="accordion">
        ...
        <shiro:hasPermission name="user:list">
            ...
            <li><a href="${ctx}/agency" class="top_level"><img src="${ctx}/static/dashboard/images/icons/Apartment%20Building.png"/>机构管理</a>
                <ul class="drawer">
                    <li><a href="${ctx}/agency/create">添加机构</a></li>
                    <li><a href="${ctx}/agency/listAll">机构列表</a></li>
                </ul>
            </li>
        <li><a href="${ctx}/teacher" class="top_level"><img src="${ctx}/static/dashboard/images/icons/User2.png"/>老师管理</a>
                <ul class="drawer">
